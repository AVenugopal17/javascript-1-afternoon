...
var dog = {name: "Lola", color: "Black", age: 6, goodBoy : true};
...
var nameCheck = function(name) {if (name === 'Steven') { return 'What is up Steven?'} else if(name === 'Bryan') {return 'Hey Bryan!';} else {return 'Cool name, ' + name}};
